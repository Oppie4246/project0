...
public class SellerControllerMvcTest {
    ...
    void mockTest() throws Exception {
        ...
        String json = this.mapper.writeValueAsString(newSellerDomain);
        System.out.println(json);

        //MvcResult mvcResult = this.mvc.perform(MockMvcRequestBuilders.get("/get")).andExpect(MockMvcResultMatchers.status().isOk()).andReturn());

        //System.out.println(mvcResult.getResponse().getContentAsString());
    }

    // SellerRepo repo;
    // SellerService ss = new SellerService(repo);
    // SellerController sc = new

    // SellerDomain updatedSellerDomain = SellerController.updateSellerDomain(1, "new firstname", null, null, null);

    // @Test
    // void testUpdate() throws Exception {
        
    //     String updatedSellerJson = this.mapper.writeValueAsString(updatedSellerDomain);
    ...
    //     ResultMatcher checkStatus = MockMvcResultMatchers.status().isOk();
    //     SellerDomain createdSellerDomain = new SellerDomain("new firstname", "surname", "email", "phone");
    //     createdSellerDomain.setId(1);
    //     String createdSellerDomainAsJson = this.mapper.writeValueAsString(createdSellerDomain);
    //     ResultMatcher checkBody = MockMvcResultMatchers.content().json(createdSellerDomainAsJson);
